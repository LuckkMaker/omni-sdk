...
struct usbd_endpoint msc_out_ep = {
    .ep_addr = MSC_OUT_EP,
    .ep_cb = NULL,
};

struct usbd_endpoint msc_in_ep = {
    .ep_addr = MSC_IN_EP,
    .ep_cb = NULL,
};
...
int msc_ram_init(uint8_t busid, uint32_t reg_base) {
    ...
    usbd_add_interface(busid, usbd_msc_init_intf(busid, &msc_intf0, MSC_OUT_EP, MSC_IN_EP));
